...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/NIMAA)](https://cran.r-project.org/package=NIMAA)
[![GitHub Release](https://img.shields.io/github/release/chendebiao/NIMAA?style=flat)](https://github.com/chendebiao/NIMAA/releases)
[![Github All Releases](https://img.shields.io/github/downloads/chendebiao/NIMAA/total.svg?style=flat)](https://github.com/chendebiao/NIMAA)
<!-- badges: end -->
...
```{r, echo=FALSE, out.width="100%", fig.cap="beatAML dataset as incidence matrix",fig.align = "center"}
...
for elements-max matrix), depends on the user's input.
...
```
```{r, echo=FALSE, out.width="30%", fig.cap="Row-wise arrangement",fig.align = "center"}
knitr::include_graphics("vignettes/Row_wise_arrangement.png")
```
```{r, echo=FALSE, out.width="100%", fig.cap="Column-wise arrangement",fig.align = "center"}
