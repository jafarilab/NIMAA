#' Find clusters in projected unipartite graphs
#' @description This function looks for the clusters in the projected unipartite graphs of the bipartite graph (the incidence matrix) that was given to it.
#'
